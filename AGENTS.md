...
- `apps/chrome-extension/service-worker.js`: Browser-agent runtime, including loopback local-control auto-connect, saved-backend reconnect fallback, CDP control, tab commands, diagnostics, and extension-internal test hooks.
