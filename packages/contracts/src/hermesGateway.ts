...
export const HermesGatewayCronJob = Schema.Struct({
  ...
  next_run_at: Schema.optional(Schema.NullOr(Schema.Union([Schema.String, Schema.Number]))),
  last_run_at: Schema.optional(Schema.NullOr(Schema.Union([Schema.String, Schema.Number]))),
  created_at: Schema.optional(Schema.NullOr(Schema.Union([Schema.String, Schema.Number]))),
  updated_at: Schema.optional(Schema.NullOr(Schema.Union([Schema.String, Schema.Number]))),
