...
export default defineConfig({
  ...
  fmt: {
    ignorePatterns: [
      ...
      "apps/mobile/android/**",
      "apps/mobile/ios/**",
      // Xcode owns these: rewriting the project file, schemes, entitlements,
      // plists, or asset catalogs would fight the IDE rather than tidy
      // anything. Swift sources are covered by SwiftLint, not this formatter.
      "apps/swift-ios/**/*.pbxproj",
      "apps/swift-ios/**/*.xcscheme",
      "apps/swift-ios/**/*.entitlements",
      "apps/swift-ios/**/*.plist",
      "apps/swift-ios/**/*.xcprivacy",
      "apps/swift-ios/**/*.xcassets/**",
      // Generated by scripts/generate-swift-contract-fixtures.ts, which
      // byte-compares its output in --check mode.
