...
import Migration0054 from "./Migrations/054_HermesCronRunOutcome.ts";
...
export const migrationEntries = [
  ...
  [54, "HermesCronRunOutcome", Migration0054],
] as const;
...
export const forkMigrationMarkers: ReadonlyArray<readonly [number, SchemaMarker]> = [
  ...
  [54, { kind: "column", table: "hermes_cron_run_watermarks", column: "last_status" }],
];
