...
// realpath, not the raw temp path: macOS hands back `/var/folders/...`, itself
// a symlink to `/private/var`, and these tests compare module URLs built from
// this directory against `realpathSync` output.
const makeTempDir = () =>
