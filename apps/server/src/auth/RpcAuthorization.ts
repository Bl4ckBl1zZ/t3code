...
export const RPC_REQUIRED_SCOPES = {
  ...
  [WS_METHODS.hermesWorkSetupStart]: AuthOrchestrationOperateScope,
  [WS_METHODS.hermesWorkSetupStatus]: AuthOrchestrationReadScope,
  [WS_METHODS.hermesWorkModelStatus]: AuthOrchestrationReadScope,
  [WS_METHODS.hermesWorkModelAuthStart]: AuthOrchestrationOperateScope,
  [WS_METHODS.hermesWorkModelAuthPoll]: AuthOrchestrationOperateScope,
  [WS_METHODS.hermesWorkModelAuthCancel]: AuthOrchestrationOperateScope,
  [WS_METHODS.hermesWorkModelSet]: AuthOrchestrationOperateScope,
