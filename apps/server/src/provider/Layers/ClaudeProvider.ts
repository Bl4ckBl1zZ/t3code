...
export { CLAUDE_AUTO_COMPACT_OPTION_ID } from "../ClaudeModelCatalog.ts";

export function getClaudeModelCapabilities(model: string | null | undefined): ModelCapabilities {
  return getClaudeCatalogModelCapabilities(BUNDLED_CLAUDE_MODEL_CATALOG, model);
}
...
export const isClaudeUltracodeEffort = isClaudeCatalogUltracodeEffort;
export function resolveClaudeApiModelId(selection: ModelSelection): string {
  return resolveClaudeCatalogApiModelId(BUNDLED_CLAUDE_MODEL_CATALOG, selection);
}
export function resolveClaudeAutoCompactTokens(selection: ModelSelection): number | undefined {
  return resolveClaudeCatalogAutoCompactTokens(BUNDLED_CLAUDE_MODEL_CATALOG, selection);
}
