...
export function threadShellFromProjection(
  ...
  return {
    ...
    titleRevision: projection.thread.titleRevision,
    titleOrigin: projection.thread.titleOrigin,
    ...
    settledRecordedAt: projection.thread.settledRecordedAt ?? null,
    ...
    workInboxRole: projection.thread.workInboxRole ?? null,
    timelineClearedAt: projection.thread.timelineClearedAt ?? null,
...
function shellFromState(input: {
  ...
  return {
    ...
    settledRecordedAt: input.state.thread.settledRecordedAt ?? null,
