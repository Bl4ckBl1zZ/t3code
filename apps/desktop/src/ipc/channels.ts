...
export const UPDATE_SET_AUTO_UPDATE_ENABLED_CHANNEL = "desktop:update-set-auto-update-enabled";
...
export const PREVIEW_SET_DEVICE_EMULATION_CHANNEL = "desktop:preview-set-device-emulation";
