...
struct SettingsProjectAutoPullView: View {
    ...
    var body: some View {
                ...
                ThreadDetailsSection(title: "Project overrides") {
                    ...
                    ForEach(projects) { project in
                        VStack(alignment: .leading, spacing: 6) {
                            Picker(project.name, selection: Binding(
        ...
        .navigationTitle("Automatic project pulls")
    ...
    private func save(_ patch: ServerSettingsPatchInput) async {
        ...
        do {
            ...
            guard current.environment?.capabilities.projectAutoPull == true else { throw FeatureCapabilityUnavailable("Automatic project pulls") }
