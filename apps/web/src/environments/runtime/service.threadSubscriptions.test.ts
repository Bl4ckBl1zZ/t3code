...
vi.mock("@t3tools/client-runtime", async (importOriginal) => {
  ...
  const stubWsClient: WsRpcClient = {
    ...
    browserAgents: {
      ...
      openOrFocusThreadTab: vi.fn(),
      attachActiveTab: vi.fn(),
      detachThreadTab: vi.fn(),
      setThreadTabControl: vi.fn(),
      startThreadTabCapture: vi.fn(),
      stopThreadTabCapture: vi.fn(),
      backThreadTab: vi.fn(),
      forwardThreadTab: vi.fn(),
      reloadThreadTab: vi.fn(),
      navigateThreadTab: vi.fn(),
