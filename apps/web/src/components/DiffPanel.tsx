      ...
      <div className="flex shrink-0 items-center gap-1 [-webkit-app-region:no-drag]">
        {codeViewFiles.length > 0 && (
          <Tooltip>
            <TooltipTrigger
              render={
                <Toggle
                  size="sm"
                  variant="ghost"
                  aria-label="Show changed-file tree"
            ...
            <TooltipPopup>{fileTreeOpen ? "Hide file tree" : "Show file tree"}</TooltipPopup>
          </Tooltip>
        )}
        {codeViewFiles.length > 0 && (
          <DiffStatLabel
        ...
        {canRefreshGitDiff && (
          <Tooltip>
            ...
            >
              <RefreshIcon size="sm" refreshing={branchDiffPreview.isPending} />
            </TooltipTrigger>
            <TooltipPopup side="top">
          ...
          <div className="flex min-h-0 min-w-0 flex-1 flex-col overflow-hidden bg-background">
            ...
            {!renderablePatch ? (
              ...
              <div className="flex min-h-0 min-w-0 flex-1">
                ...
                {fileTreeOpen && (
                  <aside className="flex w-[min(16rem,40%)] min-w-32 shrink-0 border-l border-border/60">
                    <DiffFileTree
