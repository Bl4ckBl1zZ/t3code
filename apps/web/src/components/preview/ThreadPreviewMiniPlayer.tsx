        ...
        >
          <div className="group pointer-events-auto absolute right-2 top-2 z-[49] size-3">
            <div
              ...
              className={cn(
                "absolute right-0 top-0 size-2 rounded-full shadow-sm ring-1 ring-background/70 transition-opacity group-hover:opacity-0 group-focus-within:opacity-0",
                recording ? "bg-red-500" : "bg-foreground/25",
              )}
            />
            <div
