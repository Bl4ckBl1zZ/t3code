...
import { useHeaderThreadActions } from "../../hooks/useHeaderThreadActions";
...
export const ChatHeader = memo(function ChatHeader({
  ...
  const { openMenu, closeMenu } = useHeaderThreadActions({
  ...
  return (
    ...
    >
      ...
      >
        {isServerThread ? <ThreadPullRequestsControl threadRef={activeThreadRef} /> : null}
        <div className="hidden items-center gap-3 @3xl/header-actions:flex">
          {activeProjectScripts && (
