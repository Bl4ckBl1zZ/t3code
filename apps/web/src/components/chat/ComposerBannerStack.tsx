...
export function orderComposerBanners(items: ReadonlyArray<ComposerBannerStackEntry>) {
  return items.toSorted((a, b) => bannerPriority(a) - bannerPriority(b));
}
...
export function ComposerBannerStack({ className, items }: ComposerBannerStackProps) {
  ...
  const orderedItems = orderComposerBanners(items);
          ...
          >
            ...
            >
              <div className="min-h-0 overflow-hidden">
                <div
                  className={cn(
                    "space-y-2 pb-2 transition-[opacity,transform] duration-150 ease-out",
                    stackExpanded
