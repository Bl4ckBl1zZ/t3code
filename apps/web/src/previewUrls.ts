import type { AdvertisedEndpoint, ProjectScript } from "@t3tools/contracts";
...
export const DEFAULT_PREVIEW_DEV_SERVER_URL = "http://localhost:3000/";
...
export function inferPreviewDevServerUrl(scripts: readonly ProjectScript[] | undefined): string {
  ...
  if (/\bnext\b/i.test(command)) {
    return DEFAULT_PREVIEW_DEV_SERVER_URL;
  }
